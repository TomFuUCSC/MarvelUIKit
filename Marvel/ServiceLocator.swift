...
class ServiceLocator {
    ...
    func provideSuperHeroesViewController() -> UIViewController {
        let superHeroesViewController: MarvelViewController =
    ...
    private func provideSuperHeroesPresenter(_ ui: MarvelUI) -> SuperHeroesPresenter {
    ...
    private lazy var storyBoard: MarvelStoryboard = {
        return MarvelStoryboard(name: "SuperHeroes")
    }()
